	...
	return (
		<div className="grid grid-cols-12 my-6 px-6 bg-white py-6 shadow-2xl">
			...
			<div className="col-span-12 text-center mt-4">
				{pricing.before &&
				<h2 className="text-4xl my-4 font-extrabold line-through text-black">MXN {pricing.before}</h2>
				}
				<h3 className="font-extrabold text-2xl">MXN {monthly ? pricing.monthly : pricing.annual} <span
