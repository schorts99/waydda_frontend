		...
		<div className="grid grid-cols-12 my-8 md:my-12">
			...
			<div className="col-span-12">
				...
				<div className="col-span-12">
					<button
						disabled={true}
						className="cursor-not-allowed bg-black md:w-auto w-full text-white text-white font-bold py-4 rounded mt-5 shadow-2xl px-5">REGISTRARSE
					</button>
				</div>
				<div className="col-span-12 text-center uppercase font-title mt-8">
					<Link href={"/"}>
						<a>Iniciar sesión</a>
					</Link>
				</div>
